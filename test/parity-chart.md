...
Platforms tested: iPhone, Simulator, Desktop  
...
| DOM tree has html > head + body with children | ✅ | ❌ | ❌ | ❌ | iPhone: value mismatch: hasHead = false, expected true; Simulator: value mismatch: hasHead = false, expected true; Desktop: value mismatch: hasHead = false, expected true |
...
| DOM.setOuterHTML edits element HTML directly | ✅ | ❌ | ❌ | ❌ | iPhone: value mismatch: textChanged = false, expected true; Simulator: value mismatch: textChanged = false, expected true; Desktop: value mismatch: textChanged = false, expected true |
...
| Debugger.setBreakpoint by script location | ✅ | ❌ | ❌ | ❌ | iPhone: value mismatch: success = false, expected true; Simulator: value mismatch: success = false, expected true; Desktop: value mismatch: success = false, expected true |
